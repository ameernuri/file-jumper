...
import FileJumperView from './view';


// Emitter for outside packages to subscribe to. Subscription functions
// are exponsed in ./file-jumper
export let emitter = new Emitter();


export class FileJumperController {
    constructor() {
        this.view = new FileJumperView();
        this.panel = null;
        ...
        this.disposables.add(atom.commands.add('atom-workspace', {
            'file-jumper:toggle': ::this.toggle
        }));
        this.disposables.add(atom.commands.add('.file-jumper', {
            'core:confirm': ::this.confirm,
            'core:cancel': ::this.detach,
            'application:add-project-folder': ::this.addSelectedProjectFolder,
            'file-jumper:autocomplete': ::this.autocomplete,
            'file-jumper:undo': ::this.undo,
            'file-jumper:move-cursor-down': ::this.moveCursorDown,
            'file-jumper:move-cursor-up': ::this.moveCursorUp,
            'file-jumper:move-cursor-bottom': ::this.moveCursorBottom,
            'file-jumper:move-cursor-top': ::this.moveCursorTop,
            'file-jumper:confirm-selected-or-first': ::this.confirmSelectedOrFirst,
            'file-jumper:delete-path-component': ::this.deletePathComponent,
